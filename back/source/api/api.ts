...
app.post('/listOneprovince', AuthorizeController.checkAuthorize, provinceConroller.listOne);
...
app.post('/listOnedistrict', AuthorizeController.checkAuthorize, districtConroller.listOne);
...
app.post('/listOnevillage', AuthorizeController.checkAuthorize, villageConroller.listOne);
